	...
	<body>
			...
			<div class="span10">
				...
				<dl>
					...
					<g:if test="${itemInstance?.manufacturerParty}">
						<dt><g:message code="item.manufacturerParty.label" default="Manufacturer Party" /></dt>

							<dd><g:fieldValue bean="${itemInstance}" field="manufacturerParty"/></dd>
