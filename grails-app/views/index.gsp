...
<body>
	...
	<div id="status" role="complementary">
		...
		<ul>
			...
			<li><g:link class="manage" controller="esaUser" action="list">Manage Users</g:link></li>
	...
	<div id="page-body" role="main">
		...
		<p>The EISA web site is a central knowledge and content store for Information Technology architecture. The architectural content and processes are
			specific to Intermountain Healthcare and SelectHealth. IT at Intermountain Healthcare has a long-standing tradition for developing world class systems. We
			want to continue this tradition, but with shorter release cycles. This means we will not have all the features we want, but we will deliver one or two
			features every couple of weeks. So please visit back often.</p>
		<br />
		<p>
