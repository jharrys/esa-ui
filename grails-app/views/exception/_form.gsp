...
<g:logMsg level="debug">Still rendering ... but from template _form for exception save_section.gsp</g:logMsg>
<g:logMsg level="debug">===========================================================================</g:logMsg>
	            ...
	            <div class="controls">
					...
					<g:else>
						...
						<g:if test="${question_cssclass_value == 'textArea' }">
							...
							<g:textArea id="qr${question_id }-value" name="qr${question_id }-value" rows="4" placeholder="${answer_default ?: 'type here' }" />
						</g:if>
