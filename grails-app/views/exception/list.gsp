			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="form" title="${message(code: 'document.form.label', default: 'Form')}" />
				...
				<g:each in="${documentInstanceList}" status="i" var="documentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${documentInstance.form}">${fieldValue(bean: documentInstance, field: "form")}</g:link></td>
