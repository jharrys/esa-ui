...
<html>
	...
	<body>
		<a href="#edit-esaRole" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-esaRole" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${esaRoleInstance?.version}" />
				<fieldset class="form">
