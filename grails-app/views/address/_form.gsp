...
<div class="fieldcontain ${hasErrors(bean: addressInstance, field: 'externalId', 'error')} ">
	<label for="externalId">
		<g:message code="address.externalId.label" default="External Id" />
		
	</label>
	<g:textField name="externalId" value="${addressInstance?.externalId}"/>
</div>
