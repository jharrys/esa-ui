...
<g:each in="${formFields }" var="field">
	...
	<g:if test="${!(question_datatype_exists) }">
		<!-- begin content.form.questions.statement row 24 columns wide -->
		<tr>
			<td colspan="2">
				${question_id_value }
			</td>
	...
	<g:else>
		<tr>
			...
			<td>
				<label for="question_${question_id }"> ${question_id_value }</label>
			</td>
			...
			<td>
				...
				<g:else>
					<g:if test="${question_cssclass_value == 'text area' }">
